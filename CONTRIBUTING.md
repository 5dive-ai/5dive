...
change in. It has its own repository:
[5dive-ai/5dive-ui](https://github.com/5dive-ai/5dive-ui/blob/main/CONTRIBUTING.md)
maps what exists, what is missing, and which table each missing screen reads
from.
