...
change in — and it lives in its own repository,
[5dive-ai/5dive-ui](https://github.com/5dive-ai/5dive-ui), so you do not need this
one. Its contributor page maps what exists, what is missing, and which field of
the [board document](docs/board-contract.md) each missing screen reads from.
