...
r8=$(open_of "$id8")
( cmd_task_need "$id8" --type=decision --ask="pick" --options="A|B" --ask-ok="fixture gate: the options ARE the input under test, not prose a person reads (DIVE-4462)" --recommend="A" --tier=0 ) >/dev/null 2>&1
