...
as reviewer cmd_task_need "$A" --type=decision --tier=2 --needs=human_tap --rubber-stamp-ok="fixture: this case needs a real hard-human tier-2 gate to grade; DIVE-2848 caps the hand-typed shape" --options="ship it now|hold it" --recommend="ship it now" \
...
as reviewer cmd_task_need "$G" --type=decision --tier=2 --needs=human_tap --rubber-stamp-ok="fixture: this case needs a real hard-human tier-2 gate to grade; DIVE-2848 caps the hand-typed shape" --options="ship it now|hold it" --recommend="ship it now" \
   --ask="Leave this open and parked, or close it as delivered?" >/dev/null
...
as reviewer cmd_task_need "$E" --type=decision --tier=2 --needs=human_tap --rubber-stamp-ok="fixture: this case needs a real hard-human tier-2 gate to grade; DIVE-2848 caps the hand-typed shape" --options="ship it now|hold it" --recommend="ship it now" \
...
as reviewer cmd_task_need "$I" --type=decision --tier=2 --needs=human_tap --rubber-stamp-ok="fixture: this case needs a real hard-human tier-2 gate to grade; DIVE-2848 caps the hand-typed shape" --options="ship it now|hold it" --recommend="ship it now" \
   --ask="Leave open and parked, or close as delivered?" >/dev/null
...
as lead cmd_task_need "$J" --type=decision --tier=2 --needs=human_tap --rubber-stamp-ok="fixture: this case needs a real hard-human tier-2 gate to grade; DIVE-2848 caps the hand-typed shape" --options="ship it now|hold it" --recommend="ship it now" \
...
as reviewer cmd_task_need "$K" --type=decision --tier=2 --needs=human_tap --rubber-stamp-ok="fixture: this case needs a real hard-human tier-2 gate to grade; DIVE-2848 caps the hand-typed shape" --options="ship it now|hold it" --recommend="ship it now" \
   --ask="Leave open and parked, or close as delivered?" >/dev/null
