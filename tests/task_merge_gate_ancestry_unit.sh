...
#   * DIVE-2217: delete the merged-PR acceptance warning -> case 2's receipt assertion
#     FAILS while the state transition still passes (the silent record defect reproduced).
