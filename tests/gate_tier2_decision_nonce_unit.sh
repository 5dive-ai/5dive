...
# DIVE-4462: this harness declines the gate seam — the arms read NOTIFY_NONCE, which the stubbed task_need_notify records into a shell variable.
...
seed_task DIVE-203
cmd_task_need DIVE-203 --type=decision --ask="pick a lane" --options="A|B" --ask-ok="fixture gate: the options ARE the input under test, not prose a person reads (DIVE-4462)" --recommend="A" --tier=2 --needs=human_tap --rubber-stamp-ok="fixture: this case needs a real hard-human tier-2 gate to grade; DIVE-2848 caps the hand-typed shape" >/dev/null 2>&1
...
seed_task DIVE-205
cmd_task_need DIVE-205 --type=decision --ask="pick a lane" --options="A|B" --ask-ok="fixture gate: the options ARE the input under test, not prose a person reads (DIVE-4462)" --recommend="A" --tier=1 >/dev/null 2>&1
[[ "$(tierof DIVE-205)" == "1" ]] \
...
seed_task DIVE-206
cmd_task_need DIVE-206 --type=decision --ask="pick a lane" --options="A|B" --ask-ok="fixture gate: the options ARE the input under test, not prose a person reads (DIVE-4462)" --recommend="A" --tier=2 --needs=human_tap --rubber-stamp-ok="fixture: this case needs a real hard-human tier-2 gate to grade; DIVE-2848 caps the hand-typed shape" >/dev/null 2>&1
...
seed_task DIVE-216
cmd_task_need DIVE-216 --type=decision --ask="pick a lane" --options="A|B" --ask-ok="fixture gate: the options ARE the input under test, not prose a person reads (DIVE-4462)" --recommend="A" --tier=2 --needs=human_tap --rubber-stamp-ok="fixture: this case needs a real hard-human tier-2 gate to grade; DIVE-2848 caps the hand-typed shape" >/dev/null 2>&1
...
seed_task DIVE-207
cmd_task_need DIVE-207 --type=decision --ask="pick a lane" --options="A|B" --ask-ok="fixture gate: the options ARE the input under test, not prose a person reads (DIVE-4462)" --recommend="A" --tier=2 --needs=human_tap --rubber-stamp-ok="fixture: this case needs a real hard-human tier-2 gate to grade; DIVE-2848 caps the hand-typed shape" >/dev/null 2>&1
