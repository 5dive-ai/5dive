...
( cmd_task_need DIVE-9003 --type=decision --ask="approve the spend on a bigger volume" --options="ship it now|hold it" --recommend="ship it now" >/dev/null 2>&1 )
...
( cmd_task_need DIVE-9004 --type=decision --ask="which of the two rendering libraries should the panel use, A or B" --options="ship it now|hold it" --recommend="ship it now" >/dev/null 2>&1 )
...
( cmd_task_need DIVE-9005 --type=decision --ask="?" --options="ship it now|hold it" --recommend="ship it now" >/dev/null 2>&1 )
...
( cmd_task_need DIVE-9006 --type=decision --ask="which of the two rendering libraries should the panel use, A or B" --options="ship it now|hold it" --recommend="ship it now" >/dev/null 2>&1 )
...
( cmd_task_need DIVE-9008 --type=decision --ask="approve the spend on a bigger volume" --options="ship it now|hold it" --recommend="ship it now" >/dev/null 2>&1 )
( cmd_task_need DIVE-9008 --type=decision --ask="which rendering library, A or B" --options="ship it now|hold it" --recommend="ship it now" >/dev/null 2>&1 )
...
( cmd_task_need DIVE-9009 --type=decision --ask="approve the spend on a bigger volume" --options="ship it now|hold it" --recommend="ship it now" >/dev/null 2>&1 )
