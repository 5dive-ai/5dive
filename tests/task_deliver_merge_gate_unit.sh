...
out=$(cmd_task_done DIVE-201 --result="close under test (DIVE-2773: a first close must carry a reason). CHANGED: src/x.sh CHECKED: bash tests/x.sh 3/3 pass GRADED-SHA: as stated in this result CI: green CRITERIA: (1) -> the run above" 2>&1); rc=$?
[[ $rc -eq $E_CONFLICT ]] \
...
GH_STUB_STATE="MERGED" GH_STUB_MERGED="2026-07-23T10:00:00Z" \
  out=$(cmd_task_done DIVE-201 --no-graded-sha --result="close under test (DIVE-2773: a first close must carry a reason). CHANGED: src/x.sh CHECKED: bash tests/x.sh 3/3 pass GRADED-SHA: as stated in this result CI: green CRITERIA: (1) -> the run above" 2>&1); rc=$?
...
out=$(cmd_task_done DIVE-210 --result="close under test (DIVE-2773: a first close must carry a reason). CHANGED: src/x.sh CHECKED: bash tests/x.sh 3/3 pass GRADED-SHA: as stated in this result CI: green CRITERIA: (1) -> the run above" 2>&1); rc=$?
...
GH_STUB_STATE="OPEN" GH_STUB_MERGED="" \
  out=$(cmd_task_done DIVE-202 --result="close under test (DIVE-2773: a first close must carry a reason). CHANGED: src/x.sh CHECKED: bash tests/x.sh 3/3 pass GRADED-SHA: as stated in this result CI: green CRITERIA: (1) -> the run above" 2>&1); rc=$?
...
out=$(cmd_task_done DIVE-260 --result="CHANGED: src/x.sh CHECKED: bash tests/x.sh 3/3 pass GRADED-SHA: as stated in this result CI: green CRITERIA: (1) -> the run above PASS. graded-sha: $HEAD_SHA" 2>&1); rc=$?
...
export GH_STUB_HEAD_SHA="$HEAD_SHA" GH_STUB_MERGE_SHA="$MERGE_SHA"
out=$(cmd_task_done DIVE-261 --result="CHANGED: src/x.sh CHECKED: bash tests/x.sh 3/3 pass GRADED-SHA: as stated in this result CI: green CRITERIA: (1) -> the run above PASS. graded-sha: $OTHER_SHA" 2>&1); rc=$?
[[ $rc -eq $E_CONFLICT ]] \
...
out=$(cmd_task_done DIVE-261 --force-merge-gate --result="CHANGED: src/x.sh CHECKED: bash tests/x.sh 3/3 pass GRADED-SHA: as stated in this result CI: green CRITERIA: (1) -> the run above PASS. graded-sha: $OTHER_SHA" 2>&1); rc=$?
...
export GH_STUB_HEAD_SHA="$HEAD_SHA" GH_STUB_MERGE_SHA="$MERGE_SHA"
out=$(cmd_task_done DIVE-262 --result="CHANGED: src/x.sh CHECKED: bash tests/x.sh 3/3 pass GRADED-SHA: as stated in this result CI: green CRITERIA: (1) -> the run above PASS. graded-sha: $MERGE_SHA" 2>&1); rc=$?
...
export GH_STUB_HEAD_SHA="$HEAD_SHA" GH_STUB_MERGE_SHA="$MERGE_SHA"
out=$(cmd_task_done DIVE-263 --result="CHANGED: src/x.sh CHECKED: bash tests/x.sh 3/3 pass GRADED-SHA: as stated in this result CI: green CRITERIA: (1) -> the run above PASS. graded-sha: ${HEAD_SHA:0:9}" 2>&1); rc=$?
...
export GH_STUB_HEAD_SHA="$HEAD_SHA" GH_STUB_MERGE_SHA="$MERGE_SHA"
out=$(cmd_task_done DIVE-264 --result="CHANGED: src/x.sh CHECKED: bash tests/x.sh 3/3 pass GRADED-SHA: as stated in this result CI: green CRITERIA: (1) -> the run above PASS. Rebased onto $OTHER_SHA before review." 2>&1); rc=$?
...
out=$(cmd_task_done DIVE-264 --no-graded-sha --result="CHANGED: src/x.sh CHECKED: bash tests/x.sh 3/3 pass GRADED-SHA: as stated in this result CI: green CRITERIA: (1) -> the run above PASS. Docs-only; nothing sha-shaped to grade." 2>&1); rc=$?
...
export GH_STUB_STATE="MERGED" GH_STUB_MERGED="2026-08-04T10:00:00Z"
export GH_STUB_HEAD_SHA="$HEAD_SHA" GH_STUB_MERGE_SHA="$MERGE_SHA"
out=$(cmd_task_done DIVE-266 --result="CHANGED: src/x.sh CHECKED: bash tests/x.sh 3/3 pass GRADED-SHA: as stated in this result CI: green CRITERIA: (1) -> the run above PASS. No verifier on this row." 2>&1); rc=$?
...
out=$(cmd_task_done DIVE-265 --result="CHANGED: src/x.sh CHECKED: bash tests/x.sh 3/3 pass GRADED-SHA: as stated in this result CI: green CRITERIA: (1) -> the run above PASS. graded-sha: $OTHER_SHA" 2>&1); rc=$?
...
( actor_seam_as main; cmd_task_done DIVE-270 --result="fixed, re-delivering. CHANGED: src/x.sh CHECKED: bash tests/x.sh 3/3 pass GRADED-SHA: as stated in this result CI: green CRITERIA: (1) -> the run above" ) >/dev/null 2>&1
...
out=$( actor_seam_as dev; cmd_task_done DIVE-270 --no-graded-sha --result="close under test (DIVE-2773: a first close must carry a reason). CHANGED: src/x.sh CHECKED: bash tests/x.sh 3/3 pass GRADED-SHA: as stated in this result CI: green CRITERIA: (1) -> the run above" 2>&1 ); rc=$?
[[ $rc -eq $E_CONFLICT ]] \
...
out=$( actor_seam_as dev; cmd_task_done DIVE-271 --no-graded-sha --result="close under test (DIVE-2773: a first close must carry a reason). CHANGED: src/x.sh CHECKED: bash tests/x.sh 3/3 pass GRADED-SHA: as stated in this result CI: green CRITERIA: (1) -> the run above" 2>&1 ); rc=$?
...
out=$( actor_seam_as dev; cmd_task_done DIVE-273 --no-graded-sha --result="close under test (DIVE-2773: a first close must carry a reason). CHANGED: src/x.sh CHECKED: bash tests/x.sh 3/3 pass GRADED-SHA: as stated in this result CI: green CRITERIA: (1) -> the run above" 2>&1 ); rc=$?
...
out=$( actor_seam_as dev; cmd_task_done DIVE-272 --no-graded-sha --result="close under test (DIVE-2773: a first close must carry a reason). CHANGED: src/x.sh CHECKED: bash tests/x.sh 3/3 pass GRADED-SHA: as stated in this result CI: green CRITERIA: (1) -> the run above" 2>&1 ); rc=$?
