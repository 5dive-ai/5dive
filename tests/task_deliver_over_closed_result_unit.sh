...
# (CHANGED / CHECKED / DELIVERED-SHA / CI / CRITERIA) or the delivery is refused.
...
THEIRS="main2: verifier ACK — release cut 0.9.14 confirmed green, two caveats recorded. CHANGED: src/x.sh CHECKED: bash tests/x.sh 3/3 pass DELIVERED-SHA: 1f2e3d4c5b6a79880123456789abcdef01234567 CI: green CRITERIA: (1) -> the run above"
MINE="olivia: delivering the follow-up. CHANGED: src/x.sh CHECKED: bash tests/x.sh 3/3 pass DELIVERED-SHA: 1f2e3d4c5b6a79880123456789abcdef01234567 CI: green CRITERIA: (1) -> the run above"
