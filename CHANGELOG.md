...
- **28 new assertions**, plus the pre-existing gate suites green. `tests/task_park_gate_guard_unit.sh` fails identically on clean `origin/main` (rc=6) and is untouched by this change.
