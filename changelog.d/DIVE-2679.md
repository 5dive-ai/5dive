...
Detection is net **stronger**: GitHub, Slack, AWS and PEM credentials were not
covered before and are now. Scoped to one real agent's 365 shareable facts, the
old tripwire flagged 58 files and refused; the new one is clean and still refuses
every planted credential.
