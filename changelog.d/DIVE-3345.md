...
`tests/spend_scan_not_reached_unit.sh` — 22 arms, core tier, ~1.4s, no root and no network.
...
than fake a pass. Every sick arm is paired with the SAME fixture healed, which must recompute a real
