...
- **`5dive doctor --category=creds` now carries it once**, as `merge-gate-repos:<seat>`, naming the
  ...
  (the cost that took `models` out of the default run in DIVE-3457). `5dive task merge-gate-selftest`
  remains the live re-measure. A box with no reading reports **"not measured"**, never a clean bill.
