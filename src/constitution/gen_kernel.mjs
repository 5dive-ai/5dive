...
// src/constitution/{constitution,cli}.mjs into kernel.template.sh (the bundle ships as one bash
...
for (const [tok, body, delim] of [['__CONSTITUTION_MJS__', read('constitution.mjs'), 'CONSTITUTION_KERNEL_MJS'], ['__CONSTITUTION_CLI_MJS__', read('cli.mjs'), 'CONSTITUTION_KERNEL_CLI_MJS']]) {
