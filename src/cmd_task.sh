...
# It branches on the SAME two inputs `_gate_resolve_qualified` branches on, in the same
# order, so the sentence and the lookup cannot drift apart.
_gate_search_scope() {
  local rslug="${1%%|*}" task_slug="$2"
